...
import torch_gcu
from torch_gcu.gcu.debug import AllowINT64AndUINT64Ctx
import triton
...
class CrossEntropyLoss(torch.autograd.Function):
    ...
    def forward(
        ...
        with AllowINT64AndUINT64Ctx():
            labels = labels_cpu.to(logits.device)
    ...
    def backward(ctx, grad_losses, grad_z_losses):
        ...
        n_rows, n_cols = logits.shape
        BLOCK_SIZE = min(triton.next_power_of_2(n_cols), 16384*4)
        num_warps = 4
